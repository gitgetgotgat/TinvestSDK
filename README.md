...
В методах **GetMaxLots**, **GetOrderPrice**, **PostOrder**, **PostOrderAsync**, **ReplaceOrder** и **PostStopOrder** есть обязательный входной параметр **\_minPriceIncrement**, необходимый
для задания шага цены и корректного преобразования типа double в тип units/nano.
